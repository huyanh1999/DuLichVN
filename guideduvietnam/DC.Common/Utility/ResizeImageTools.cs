...
{
    public static class ResizeImageTools
    {
        /// <summary>
        /// Save image as jpeg
        /// </summary>
        ...
        public static void PerformImageResizeAndPutOnCanvas(string pFilePath, string pFileName, int pWidth, int pHeight, string pOutputFileName)
        {
            ...
            _imgR = ResizeImageTools.Resize(imgBef, pWidth, pHeight, true);


            System.Drawing.Image _img2;
            _img2 = ResizeImageTools.PutOnCanvas(_imgR, pWidth, pHeight, System.Drawing.Color.White);

            //Save JPEG
            ResizeImageTools.SaveJpeg(pFilePath + pOutputFileName, _img2);
            imgBef.Dispose();
