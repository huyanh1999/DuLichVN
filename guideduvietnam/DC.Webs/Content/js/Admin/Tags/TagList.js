var viewModel = new function () {
    ...
    self.TagOptions = ko.observableArray(data.TagOptions !=null? data.TagOptions:[]);
    ...
    function FilterData() {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                viewModel.TagItems(data.TagItems == null ? [] : data.TagItems);
            },
...
ko.applyBindings(viewModel, document.getElementById("tagsList"));
//// Onload
// jQuery
