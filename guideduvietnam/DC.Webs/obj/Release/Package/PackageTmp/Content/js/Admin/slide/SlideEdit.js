...
var viewModel = new function () {
    ...
    self.Name = ko.observable(data.SliderInfo.Name)
    ...
    self.Url = ko.observable(data.SliderInfo.Url).extend({ maxLength: 500 });
    self.OrderBy = ko.observable(data.SliderInfo.OrderBy).extend({ number: { message: "Chỉ được nhập số" } });
    self.Description = ko.observable(data.SliderInfo.Description);
...
ko.applyBindings(viewModel, document.getElementById("editSlider"));